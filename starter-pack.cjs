(function (root, factory) {
  ...
  const starterPack = [
    ...
    },
    {
      ...
      description: "Useful when forms ask for both your passport number and expiry date.",
      suffix: "ppexp",
      requiredProfileFields: ["passportExpiryDate"],
      placeholder: "14 March 2030",
      build: (profile) => profile.passportExpiryDate || "14 March 2030",
    },
    {
      id: "idNumber",
      category: "Identity",
